    ...
    public static void cadastrarVagas() {
        ...
        do {
            ...
            for (int i = 0; ((opcaoB == true) && (i < Domestica.listaVagas.length)); i++) {
                ...
                Domestica.listaVagas[i] = new DadosVaga();
                ...
                System.out.println("Informe a categoria da vaga? \n"
                        + "(Domestica / Eletricista / Pintura / Pedreiro)"); //SOLICITA A CATEGORIA
                ...
                System.out.println("Quanto será o salário da diária?");//SOLICITA O SALARIO
                Domestica.listaVagas[i].salarioDiaria = Domestica.entrada.nextDouble();
                //ESVAZIA A ENTRADA
                Domestica.entrada.nextLine();
                ...
                Domestica.listaVagas[i].diasTrabalho = Domestica.entrada.nextByte();
                // VALIDA SE FOR MAIOR QUE 7 E MENOR QUE 1 DIA
                while ((Domestica.listaVagas[i].diasTrabalho < 1) || (Domestica.listaVagas[i].diasTrabalho > 7)) {
